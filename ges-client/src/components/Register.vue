    ...
    <div class="wrapper">
        ...
        <div>
            <form class="two-column-form">
                ...
                <div class="column">                    
                    <input v-model="user.years_experience" type="text" placeholder="Major" />
                    <input v-model="user.languages" type="text" placeholder="Status (Freshman, Sophomore, Junior, Senior)" />
